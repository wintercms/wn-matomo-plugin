<?php return [
    ...
    'reportwidgets' => [
        ...
        'visits_summary' => [
            ...
            'period' => 'Period',
            'period_desc' => 'Select the reporting period used for the summary.',
            'period_options' => [
                'day' => 'Day',
                'week' => 'Week',
                'month' => 'Month',
            ...
            'date' => 'Date',
            'date_desc' => 'Select the date range used for the summary.',
            'date_options' => [
                'today' => 'Today',
                'yesterday' => 'Yesterday',
                'last7' => 'Last 7 days',
        ...
        'top_pages' => [
            ...
            'period' => 'Period',
            'period_desc' => 'Select the reporting period used for the top pages.',
            'period_options' => [
                'day' => 'Day',
                'week' => 'Week',
                'month' => 'Month',
            ...
            'date' => 'Date',
            'date_desc' => 'Select the date range used for the top pages.',
            'date_options' => [
                'today' => 'Today',
                'yesterday' => 'Yesterday',
                'last7' => 'Last 7 days',
            ...
            'selected_view_mode' => 'View mode',
            'view_mode' => 'View mode',
            'view_mode_desc' => 'Choose whether to show the top pages as a flat list or a hierarchical tree.',
            'view_mode_options' => [
                'flat' => 'Flat',
                'hierarchical' => 'Hierarchical',
            ],
            'exclude_low_pop' => 'Exclude low-traffic pages',
        ...
        'user_country' => [
            ...
            'period' => 'Period',
            'period_desc' => 'Select the reporting period used for countries.',
            'period_options' => [
                'day' => 'Day',
                'week' => 'Week',
                'month' => 'Month',
            ...
            'date' => 'Date',
            'date_desc' => 'Select the date range used for countries.',
            'date_options' => [
                'today' => 'Today',
                'yesterday' => 'Yesterday',
                'last7' => 'Last 7 days',
